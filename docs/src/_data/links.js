module.exports = [
  ...
  },
  {
    ...
    items: [
      { url: 'background-colors', name: 'Background colors' },
      { url: 'background-opacity', name: 'Background opacity' },
      { url: 'background-gradients', name: 'Background gradients' },
    ],
  },
  {
    groupName: 'Borders',
    items: [
      { url: 'border-colors', name: 'Borders colors' },
      { url: 'border-radius', name: 'Borders radius' },
      { url: 'border-width', name: 'Borders width' },
    ],
  },
  {
    groupName: 'Dimensions',
    items: [
      { url: 'dimensions-width', name: 'Width' },
      { url: 'dimensions-height', name: 'Height' },
